...
data class SanDetailImageData(val mountain: String, val img: Int) {
    companion object {
        ...
        val northhansanList = mutableListOf(
        ...
        val seullacksanList = mutableListOf(
        ...
        val sobaeksanList = mutableListOf(
        ...
        val sokrisanList = mutableListOf(
        ...
        val hanrasanList = mutableListOf(
